...
def cek_apk(session,coki):
	w=session.get("https://www.facebook.com/mdnayemhasan5258",cookies={"cookie":coki}).text
...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["X","X"]:
		os.system('xdg-open https://www.facebook.com/mdnayemhasan5258');time.sleep(1)
		fb()
	if opt in ["C","3"]:
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-openhttps://github.com/account786');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/account786/Clone-fb.git").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        os.system("xdg-open https://www.facebook.com/mdnayemhasan5258/")
        time.sleep(3.0)
